...
public class AddressController {
	...
	public Result add(@RequestBody TbAddress address){
		try {
			...
			System.out.println("别名s"+address.getAlias());
	...
	//根据用户查询地址
	@RequestMapping("findListaddressbyuser")
	public List<TbAddress> findListaddressbyuser( ){
		String name = SecurityContextHolder.getContext().getAuthentication().getName();   //获取当前用户
		return addressService.findaddress(name);
	}
